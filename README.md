...
```bash
python src/generate_sequences.py --workers 1 --seeds 2,1,3 --max-n 30 --check-ssd --out-dir data/longer_seeds
```

To generate default sequences:

```bash
python src/generate_sequences.py --workers 13 --max-n 30
```
